...
class ErrorListModule(AbstractModule):
    ...
    def run(self):
        ...
        f = open(self.outputdir + 'errorlist_comparison.test.inst','w')
        for currentword in self.doc.words():            f.write( str(currentword) + ' ')
        f.close()
...
class LexiconModule(AbstractModule):
    ...
    def run(self):                
        #Call module and ask it to produce output
        self.runcmd(self.rootdir + 'spellmods/lexicon_checker ' + self.rootdir + 'spellmods/ValkuilLexicon.1.3.freq20.length3.lex ' + self.outputdir + 'input.tok.txt > ' + self.outputdir + 'lexicon_checker.test.out')
...
class SoundAlikeModule(AbstractModule):
    ...
    def run(self):                
        #Call module and ask it to produce output
        self.runcmd(self.rootdir + 'spellmods/soundalike_checker ' + self.rootdir + 'spellmods/ValkuilLexicon.1.3.freq20.length3.lex ' + self.outputdir + 'input.tok.txt > ' + self.outputdir + 'soundalike_checker.test.out')
...
class GarbageChecker(AbstractModule):
    ...
    def run(self):                
        #Call module and ask it to produce output
        self.runcmd(self.rootdir + 'spellmods/garbage_checker ' + self.rootdir + 'spellmods/ValkuilLexicon.1.3.freq20.length3.lex ' + self.outputdir + 'input.tok.txt > ' + self.outputdir + 'garbage_checker.test.out')
...
class SplitChecker(AbstractModule): #(merges in FoLiA terminology)
    ...
    def run(self):                
        #Call module and ask it to produce output
        self.runcmd(self.rootdir + 'spellmods/split_checker ' + self.rootdir + 'spellmods/ValkuilLexicon.1.3.freq20.length3.lex ' + self.rootdir + 'spellmods/ValkuilSplitRunon.1.0 ' + self.outputdir + 'input.tok.txt > ' + self.outputdir + 'split_checker.test.out')
...
class RunonChecker(AbstractModule): #(splits in FoLiA terminology)
    ...
    def run(self):                
        #Call module and ask it to produce output
        self.runcmd(self.rootdir + 'spellmods/runon_checker ' + self.rootdir + 'spellmods/ValkuilLexicon.1.3.freq20.length3.lex ' + self.rootdir + 'spellmods/ValkuilSplitRunon.1.0 ' + self.outputdir + 'input.tok.txt > ' + self.outputdir + 'runon_checker.test.out')
...
modules = [WOPRChecker, ErrorListModule, LexiconModule, SoundAlikeModule, SplitChecker, RunonChecker, D_DT_Checker, T_DT_Checker, ZEI_ZIJ_Checker, NOG_NOCH_Checker, HARD_HART_Checker, LICHT_LIGT_Checker, GROOTTE_GROTE_Checker, WIL_WILT_Checker, DEZE_DIT_Checker, DIE_WELKE_Checker]
